package io.initialcapacity.emailverifier.collector
...
val ANALYZER_QUEUE = getEnvStr("ANALYZER_QUEUE", "analyzer-queue-collector-app")

val COLLECTOR_EXCHANGE = getEnvStr("COLLECTOR_EXCHANGE", "collector-exchange")
val COLLECTOR_QUEUE = getEnvStr("COLLECTOR_QUEUE", "collector-queue-collector-app")
